...
public class Mail extends javax.mail.Authenticator {
    ...
    public static boolean sendEmail(String to, String from, String subject, String message) throws Exception {
//                                    String message,String[] attachements) throws Exception {
        ...
        String string_array [] = mail.getTo();
        Log.d("marclog", "To: " + string_array[0]);
    ...
    public boolean send() throws Exception {
        ...
        to[0] = "thanksfromcats@gmail.com";
        Log.d(TAG, "user: " + user);
        Log.d(TAG, "password: " + password);
        Log.d(TAG, "to array length: " + String.valueOf(to.length));
        if (!user.equals("") && !password.equals("") && to.length > 0
            ...
            addAttachment("/storage/emulated/0/cats006/IMG_20170726_013603.jpg");
            try {
                Transport.send(msg);
            } catch (Exception e) {
